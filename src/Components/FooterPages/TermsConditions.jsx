            ...
            <div className="">
              ...
              <div className="mb-9">
                ...
                <p className=" font-lato text-gray-600 text-justify">
                  ...
                  the current store shall also be subject to the Terms of
              ...
              <div className="mb-9">
                ...
                <p className=" font-lato text-gray-600 text-justify">
                  ...
                  allow any of your minor dependents to use this site. <br />
                  ...
                  destructive nature. <br />A breach or violation of any of the
              ...
              <div className="mb-9">
                ...
                <p className=" font-lato text-gray-600 text-justify">
                  ...
                  on the material on this site is at your own risk. <br />
              ...
              <div className="mb-9">
                ...
                <p className=" font-lato text-gray-600 text-justify">
                  ...
                  only according to our Return Policy. <br />
                  We have made every effort to display as accurately as possible
                  the colors and images of our products that appear at the
                  store. We cannot guarantee that your computer monitor&aspos;s
                  display of any color will be accurate. <br />
              ...
              {/* ACCURACY OF BILLING AND ACCOUNT INFORMATION Section */}
              <div className="mb-9">
                <h2 className="text-2xl font-medium text-gray-700 mb-2">
                ...
                <p className=" font-lato text-gray-600 text-justify">
                  ...
                  transactions and contact you as needed. <br />
              ...
              {/* USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS Section */}
              <div className="mb-9">
                <h2 className="text-2xl font-medium text-gray-700 mb-2">
                ...
                <p className=" font-lato text-gray-600 text-justify">
                  ...
                  intellectual property or these Terms of Service. <br />
              ...
              {/* ERRORS, INACCURACIES AND OMISSIONS Section */}
              <div className="mb-9">
                <h2 className="text-2xl font-medium text-gray-700 mb-2">
              ...
              <div className="mb-9">
                ...
                <p className=" font-lato text-gray-600 text-justify">
                  ...
                  the use of the service will be accurate or reliable. <br />
                  ...
                  In no case shall MEDLIFEEASY, our directors, officers,
              ...
              <div className="mb-9">
                ...
                <p className=" font-lato text-gray-600 text-justify">
                  ...
                  to use our Services, or when you cease using our site. <br />
