  ...
  return (
    <div className="flex justify-center relative py-[12px]">
      ...
      >
        {isLoading ? (
          ...
          allReviews.map((review, index) => (
            <SwiperSlide key={index}>
              <div className="px-[33px] py-5 flex justify-center items-center w-full mb-5 lg:mb-10 font-lato">
                <div className="bg-white min-h-[300px] w-full p-3 rounded-xl shadow-md cursor-pointer transform transition-transform duration-300 hover:-translate-y-2">
                  ...
                  <p className="text-gray-800 text-sm md:text-[13px] font-lato text-justify">
                    {review?.review}
                  </p>
                </div>
              </div>
        ...
        <div className="absolute top-[40%] w-full z-10 hidden md:block">
